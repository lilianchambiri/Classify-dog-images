...
def get_pet_labels(image_dir="pet_images/"):
    ...
    for filename in in_files:
      ...
      if filename[0] != ".":
        ...
        pet_label = ""
            ...
            # Process the filename to extract the pet label (breed)
            # Assuming the filename structure like 'Boston_terrier_02259.jpg'
            # Split the filename by underscores and remove the file extension
           
        breed = filename.split('_')[:-1]  # Exclude the number part and extension
        pet_label = ' '.join(breed).lower().strip()
    ...
    # Return the results_dic dictionary containing filenames and labels
