...
def get_input_args():
    ...
    parse.add_argument('--arch', type=str, default = 'vgg', help="the CNN model architecture" )
    parse.add_argument('--dogfile', type=str, default = 'dognames.txt', help="text file of names of dog breeds" )
